...
def process_phieu_nhap_task(self, payload: dict):
    """
    Xử lý một phiếu nhập duy nhất: nhận payload đã chuẩn bị, gọi API, cập nhật kết quả.
    ...
    try:
        ...
        # Gọi API đối tác
        api_response = partner_api_client.submit_phieu_nhap(payload)
        # Xử lý thành công
